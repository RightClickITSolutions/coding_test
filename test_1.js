...
const HardDrive = prompt("Enter the size of the your hard drive ");
const printActual = (HardDrive.valueOf() * 37.25) / 40;
alert("Actual storage capacity of the hard drive is " + printActual);
